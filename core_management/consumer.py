...
from core_management.rabbit_message_responder import on_messege_recived
...
class Rabbit_Consumer(object):
    ...
    HOSTNAME = HOST_CONSUMER
    EXCHANGE = 'new_control_exchange'

    EXCHANGE_TYPE = 'topic'
    VIRTUAL_HOST = 'new_system_control'
    QUEUE = 'main_control_queue'
    ROUTING_KEY = 'abc_xyz'
    CREDENTIALS = None
    THREAD_LIST = []
    ...
    def __init__(self):
        ...
        self.CREDENTIALS = pika.credentials.PlainCredentials(self.USERNAME, self.PASSWORD)
    ...
    def setup_exchange(self, exchange_name):
        ...
        self._channel.exchange_declare(
            ...
            callback=cb, durable=True, auto_delete=True)
    ...
    def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        th = threading.Thread(target=on_messege_recived, args=(data,)).start()
...
# def main():
#     consumer = Reconnecting_Rabbit_Consumner()
#     consumer.run()
#
#
...
# if __name__ == '__main__':
#     main()
# >>>>>>> d71af4aba01bd2539933d7b4794b215391435ebd
