...
class ElasticsearchHandler(object):
    ...
    def __init__(self):
        self.es = None
        self.cluster_ip = '192.168.18.155'
        self.port = '9200'
        self.username = 'elastic'
        self.password = 'uLTpJqxVihdXTIH7vXKO'
        if self.connect():
...
abc = obj.get_response_by_gtr(index='twitter_profile_posts', gtr_id='st_tw_58', limit=1000)
print(abc)
